...
const Aboutus = () => {
  ...
  return (
    <div className="w-full font-[plus-jakarta-sans] overflow-x-hidden">
      ...
      <section className="relative flex flex-col-reverse md:flex-row min-h-[90vh] w-full px-4 md:px-8 lg:px-16 overflow-hidden">
        ...
        {/* Content */}
        <div className="relative z-20 md:w-[55%] flex flex-col justify-center h-auto py-10 md:py-0">
          <motion.h2 
  ...
  <div className="w-full max-w-[900px] h-full flex items-center justify-center">
    <motion.img 
      src={about} 
      alt="About Stockbox" 
    ...
    />
      ...
      {/* Vision Section */}
      <section className="w-full px-4 md:px-8 lg:px-16 py-12 relative z-30">
