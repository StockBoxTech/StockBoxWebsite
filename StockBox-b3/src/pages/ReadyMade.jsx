...
const ReadyMade = () => {
  ...
  return (
    <div className="ready-made w-full h-full pr-10" >
        <div className="w-full md:flex items-center ">

          <div  className="md:w-1/2 md:ml-2 relative">
       <img src={art} alt="art" className=""/>
        <h1 className="md:text-7xl font-bold text-white flex flex-col gap-5 text-[50px] absolute md:top-[30vh] md:left-[4vh] top-[10vh]">
