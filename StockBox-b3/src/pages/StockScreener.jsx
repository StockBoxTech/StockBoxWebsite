...
const StockScreener = () => {
  return (
    <div className="w-full min-h-screen px-4 md:px-8 lg:px-16 py-12 text-white">
      {/* Hero Section */}
      <div className="mx-auto mb-20 md:mb-28 grid md:grid-cols-2 gap-8 items-center">
        <div className="relative group rounded-2xl overflow-hidden w-full flex items-end">
          <img
            src={art}
            alt="Stock analysis"
            className="w-[40%] object-contain transition-all duration-300 ml-auto"
          />
  ...
  src={ready}
  alt="Stock ratings"
  className="shadow-xl w-[30rem] md:w-[40rem] max-w-full object-contain mx-auto"
/>
